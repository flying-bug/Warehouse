...
@WebServlet(name = "ListRequestForQuotationServlet", urlPatterns = {"/listRequestForQuotation"})
public class ListRequestForQuotationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (keyword != null && !keyword.trim().isEmpty()) {
            conditions.add("(code LIKE '%" + keyword + "%')");
        }
        ...
        req.setAttribute("PAGE_CONTENT", "/views/purchases/listRequestForQuotation.jsp");
